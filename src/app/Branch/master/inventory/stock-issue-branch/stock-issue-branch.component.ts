...
@Component({
  selector: 'app-stock-issue-branch',
  templateUrl: './stock-issue-branch.component.html',
  styleUrls: ['./stock-issue-branch.component.css']
})
export class StockIssueBranchComponent implements OnInit, OnChanges, AfterViewInit {
  ...
  ngOnChanges(): void {
    if (this.branchData.Data && this.branchData.Data.length > 0) {
      this.dataSource = new MatTableDataSource<any>(this.branchData.Data);
