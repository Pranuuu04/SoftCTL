...
@Component({
  selector: 'app-volumatric-report',
  templateUrl: './volumatric-report.component.html',
  styleUrls: ['./volumatric-report.component.css']
})
export class VolumatricReportComponent implements OnInit {
